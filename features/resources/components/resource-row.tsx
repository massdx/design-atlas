        ...
        >
            ...
            <div className="pointer-events-none relative z-10 flex items-center gap-3 px-1.5 py-2 transition-colors duration-100 ease-out group-data-active/row:text-[#E8E8E3]">
                <div className="flex min-w-0 items-center gap-2 transition-transform duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] group-data-active/row:translate-x-2.5">
                    ...
                    />
                    <span className="min-w-0 flex-1 truncate text-[14px] font-medium leading-7 text-[#080807] transition-colors duration-100 ease-out group-data-active/row:text-[#E8E8E3] sm:flex-none sm:shrink-0 sm:overflow-visible sm:whitespace-nowrap">
                        {resource.title}
                    </span>
                    <span
                        aria-hidden
                    ...
                    />
                    <span className="hidden min-w-0 flex-1 truncate font-(--font-dm-mono) text-[14px] leading-7 text-[#080807]/40 transition-colors duration-100 ease-out group-data-active/row:text-[#E8E8E3]/60 sm:inline">
