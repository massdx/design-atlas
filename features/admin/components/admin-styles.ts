/**
 * Shared className utilities for the admin/manager surface.
 * Keeps the same flat / cream design language as the public submit dialog
 * while continuing to compose shadcn base components.
 */

export const ADMIN_INPUT_CLASS =
    "h-9 w-full rounded-none border-0 bg-[#F5F5F5] px-3 text-[13px] shadow-2xs placeholder:text-[#757575] focus-visible:ring-1 focus-visible:ring-[#080807]/50";

export const ADMIN_TEXTAREA_CLASS =
    "w-full rounded-none border-0 bg-[#F5F5F5] px-3 py-2 text-[13px] shadow-2xs placeholder:text-[#757575] focus-visible:ring-1 focus-visible:ring-[#080807]/50";
